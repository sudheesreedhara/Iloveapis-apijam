...
**1.3 **Navigate the **Develop** → **API Proxies** on the left side menu, click **+ Proxy** in the top right corner to invoke the Create Proxy Wizard. Then select **Proxy Bundle**, and click next. 		![image alt text](image_2.png)
...
**1.5 **Click on the link to view your API proxy in Proxy Editor. Then click the **Deployment **dropdown, select the **test** environment, then **Deploy** from the **Overview **tab. ![image alt text](image_3.png)
...
Navigate back to the **Trace **right side tab bar menu, click on the **Spike Arrest** policy icon in the **Transaction Map** to view the flow details in the **Phase Details** section below.** **![image alt text](image_6.png)
